...
<div class="row">
    ...
    <div class="col-md-9" style="border-left:thin solid #B4B2B2;">
    	<p class="box-title">Incoming files </p>
   		<div class="col-md-5 col-sm-12" id="itemslist">
        <div class="col-md-4 fileholder" data-id="2" data-desc="File from The director" id="indfile">
        	<img src="../img/ng.jpg" height="60" width="70">
            <p>FIle No 343</p>
        </div>
        <div class="col-md-4">
        	<img src="../img/ng.jpg" height="60" width="70">
        ...
        <div class="col-md-5 displayfile">
